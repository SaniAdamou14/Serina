    ...
    <div className="space-y-6">
      ...
      <div className="card">
        <div className="border-b border-gray-200 pb-4 mb-6">
          ...
          <p className="text-sm text-gray-600">Surveillance des populations et analyse des descendants évolutifs</p>
        </div>
        ...
        <div className="space-y-4">
          {simulationData.species.map((species) => (
            <div key={species.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              {/* Traits dominants réels */}
              <div className="mt-4 pt-4 border-t border-gray-200">
                <div className="text-xs text-gray-600 mb-2">Traits dominants</div>
                <div className="flex flex-wrap gap-2">
                  {Object.entries(species.averageTrait)
                    .sort(([,a], [,b]) => b - a)
                    .slice(0, 3)
                    .map(([trait, value]) => (
        ...
        {/* Bouton d'évolution assistée */}
        <div className="mt-6 pt-6 border-t border-gray-200">
          <button className="w-full button-secondary">
            🧬 Analyser l'évolution des lignées
          </button>
        </div>
      </div>
