...
![Serina Logo](https://img.shields.io/badge/Serina-Evolution%20Simulator-blue?style=flat-square)
...
- 🌍 **Environnements multiples** : 4+ zones climatiques avec conditions spécifiques
...
- 🚀 **Mode autonome** : Runner indépendant avec gestion signaux et snapshots automatiques
...
```bash
# Cloner le projet
git clone https://github.com/[username]/serina.git
cd serina
...
### Configuration pybind11 (si nécessaire)

```bash
# Spécifier manuellement le chemin pybind11
cmake -S . -B build -DPYBIND11_ROOT="/chemin/vers/pybind11"
```

## � Utilisation

### Lancement Rapide - Mode Autonome
...
```bash
# Simulation infinie (arrêt Ctrl+C)
./run_serina.sh
...
./run_serina.sh -g 5000 -s 100 -l 5 -o mon_experience -p 2000

# Mode simple (sans évolution avancée)
